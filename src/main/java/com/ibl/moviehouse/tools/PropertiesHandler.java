...
public class PropertiesHandler {
    ...
    public String getClientId() {return prop.getProperty(PROP_CLIENT_ID);}
    public String getProjectId() {return prop.getProperty(PROP_PROJECT_ID);}
    public String getCookieName() {return prop.getProperty(PROP_COOKIE_NAME);}
    public String getServiceAccountEmail() {return prop.getProperty(PROP_SERVICE_ACCOUNT_EMAIL);}
    public String getWidgetUrl() {return prop.getProperty(PROP_WIDGET_URL);}
    public String getKeyFile() {return prop.getProperty(PROP_KEY_FILE);}
}
